...
export const ru = {
  ...
  'auth.consent.processing.label': 'Даю согласие на обработку моих персональных данных на условиях <a href="privacy.html" target="_blank" rel="noopener noreferrer">политики конфиденциальности</a>.',
  'auth.consent.rules.label': 'Принимаю <a href="privacy.html#rules" target="_blank" rel="noopener noreferrer">правила клуба</a>.',
  ...
  'auth.action.password_show': 'Показать',
  'auth.action.password_show.aria': 'Показать пароль',
  'auth.action.password_hide': 'Скрыть',
  'auth.action.password_hide.aria': 'Скрыть пароль',
  ...
  'reconsent.title': 'Подтверди согласие, чтобы продолжить',
  'reconsent.text': 'Твой аккаунт создан до текущей версии политики. Прочитай её и подтверди согласие на обработку персональных данных.',
  'reconsent.consent.label': 'Даю согласие на обработку моих персональных данных на условиях <a href="/privacy.html" target="_blank" rel="noopener noreferrer">политики конфиденциальности</a>.',
  'reconsent.action.confirm': 'Подтвердить и продолжить',
  'reconsent.action.signout': 'Выйти',
  'reconsent.action.retry': 'Повторить проверку',
  'reconsent.status.checking': 'Проверяем актуальную версию согласия…',
  'reconsent.success': 'Согласие сохранено.',
  'reconsent.error.required': 'Подтверди согласие на обработку персональных данных.',
  'reconsent.error.check': 'Не удалось проверить согласие. Проверь интернет и повтори.',
  'reconsent.error.save': 'Не удалось сохранить согласие. Попробуй ещё раз.',
  'reconsent.error.signout': 'Не удалось выйти. Проверь интернет и попробуй ещё раз.',
  ...
  'me.consent.heading': 'Публикация контактов',
  'me.consent.intro': 'Контакты увидят все посетители профиля. Поэтому по требованиям закона о персональных данных нам нужно отдельно получить и сохранить твоё согласие.',
  'me.field.contacts.heading': 'Контакты',
  'me.field.contacts.warning': 'Все поля необязательны. После согласия выше заполненные контакты будут видны всем на странице профиля.',
  'me.consent.full_name.label': 'Как тебя зовут полностью',
  'me.consent.full_name.placeholder': 'ФИО',
  'me.consent.full_name.hint': 'Укажи фамилию и имя, отчество — если есть. Эти данные нужны только для подтверждения согласия: мы храним их в закрытом журнале и не показываем в профиле.',
  'me.consent.full_name.required': 'Укажи фамилию и имя. Отчество добавь, если оно есть.',
  'me.consent.dissemination.label': 'Разрешаю показывать указанные ниже контакты всем посетителям моего публичного профиля.',
  'me.consent.dissemination.link': 'Что именно публикуется и как отозвать согласие',
  ...
  'me.consent.dissemination.version_invalid': 'Текст согласия обновился. Перезагрузи страницу и подтверди его заново.',
