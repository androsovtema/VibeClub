...
export const ru = {
  ...
  'auth.error.link_expired': 'Ссылка из письма устарела или уже использована. Запроси новую.',
  ...
  'project.comment.error.max_len': 'Комментарий слишком длинный — максимум 2000 символов.',
  'project.comment.error.cooldown': 'Подожди немного между комментариями.',
  'project.comment.error.hourly': 'Слишком много комментариев за час, вернись позже.',
  ...
  'me.field.github': 'GitHub',
  'me.field.github.placeholder': 'ник или ссылка на профиль',
  'me.field.phone': 'Телефон',
  'me.field.phone.placeholder': '+7 999 123-45-67',
  'me.field.email_public': 'Публичная почта',
  'me.field.email_public.placeholder': 'видна всем на профиле',
  'me.field.custom_link': 'Своя ссылка',
  'me.field.custom_link.label_placeholder': 'название, например «Личный сайт»',
  'me.field.custom_link.url_placeholder': 'https://…',
  ...
  'me.error.bio_len': 'Био слишком длинное — максимум 500 символов.',
  ...
  'me.error.phone': 'Проверь номер — цифры и + в начале.',
  'me.error.email_public': 'Проверь почту — формат вида name@example.com.',
  'me.error.github': 'Только ник с GitHub — латиница, цифры, дефис.',
  'me.error.custom_link_url': 'Ссылка должна начинаться с http:// или https://.',
